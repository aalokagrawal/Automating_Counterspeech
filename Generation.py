...
# def get_template(type_counter=None):
#     # to generate prompts based on cluster center
#     prompts_df=pd.read_csv("./counterspeech classification/prompts.csv")
...
params = {
    ...
    'prepend_path':'Additional_datasets/frequent_phrases.json',
    'device': 'cuda',
    'batch_size':32,
...
if __name__ == "__main__":
    ...
    if params['slur_removed']:
        ...
        params['path_datasets']='../Counterspeech-Argument/Datasets'
