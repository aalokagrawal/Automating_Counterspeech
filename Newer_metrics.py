...
#     print(ref_dict)
    ...
    if(metric=='bleurt'):
        ...
        counterspeech_score=Argument_scoring(model_path='Hate-speech-CNERG/counterspeech-quality-bert',cache_path='../Saved_models',max_length=100, batch_size=16,use_gpu=True)
        ...
        counter_argument_score=Counter_argument_scoring(model_path='Hate-speech-CNERG/argument-quality-bert',cache_path='../Saved_models',max_length=200, batch_size=8,use_gpu=True)
